...
import com.example.expensescontrol.ui.nonregular.NonRegularScreen
import com.example.expensescontrol.ui.nonregular.NonRegularScreenDestination
    ...
    NavHost(
        ...
        composable(route = MainScreenDestination.route) {
            MainScreen(
                ...
                navigateAddNonRegular = { navController.navigate(NonRegularScreenDestination.route) }
            )
        }
        ...
        composable(route = NonRegularScreenDestination.route) {
            NonRegularScreen(
                navigateToMainScreen = { navController.navigate(MainScreenDestination.route) })
        }
    }
